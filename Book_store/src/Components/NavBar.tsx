...
const NavBar = () => {
  ...
  <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
    <div className="relative flex h-16 items-center justify-between">
      ...
      <div className="flex shrink-0 items-center gap-2">
        <img
           ...
           className="h-6 w-6"
        />
        <span className="text-xl font-bold text-white tracking-wide">Book Store</span>
       </div>
    ...
    >
      Home
      <FaHome className="ml-2 text-yellow-900" />
    </a>
    <a
      href="#"
    ...
    >
      Cards
      <FaShoppingCart className="ml-2 text-yellow-900" />
    </a>
    <a
      href="#"
        ...
        <div className="relative ml-3">
          <div>
            <button type="button" className="relative flex rounded-full bg-gray-800 text-sm focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-hidden" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
              ...
              <img className="size-8 rounded-full" src="https://images.unsplash.com/photo-1524995997946-a1c2e315a42f" alt=""/>
            </button>
          </div>
        </div>
      </div>
